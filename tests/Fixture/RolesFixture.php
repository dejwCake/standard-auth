...
class RolesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'ROLES_NAME_UNIQUE' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
            'ROLES_TITLE_UNIQUE' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'enabled' => 1,
            'created' => '2017-01-05 21:27:22',
            'modified' => '2017-01-05 21:27:22',
            'deleted' => '2017-01-05 21:27:22'
        ],
    ];
}
